...
/// </summary>
public class Id4ConfigurationDbContext : ConfigurationDbContext<Id4ConfigurationDbContext>
{
    public Id4ConfigurationDbContext(DbContextOptions<Id4ConfigurationDbContext> options, ConfigurationStoreOptions storeOptions)
