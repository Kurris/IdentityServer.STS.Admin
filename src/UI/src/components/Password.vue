<template>
	<div id="password">
		<template v-if="status"> 旧密码:<el-input v-model="form.oldPassword"></el-input> </template>

		<p v-if="!status">你还没有设置密码，设置一个密码，以便无需外部登录即可登录</p>

		新密码:<el-input v-model="form.newPassword"></el-input> 确定密码:<el-input v-model="form.confirmPassword"></el-input>
