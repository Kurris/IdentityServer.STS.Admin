<template>
	<div class="consent" v-if="setting != null">
		<div class="logo">
			...
			<div v-for="n in 7" :key="'left' + n" class="dashed" style="height: 2px; width: 4px; background-color: #ced5db">
			</div>
		...
		<div class="panel">
			<div class="notice">
				...
				<div class="extension">
					...
					<div v-if="setting.allowRememberConsent" style="font-size: 10px; color: #91969b; margin-top: 2px">
